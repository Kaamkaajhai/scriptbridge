          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
            {sections.map((s) => (
              <li key={s.id}>
                <a
                  href={`#${s.id}`}
                  className="text-sm text-gray-700 hover:text-cyan-600 transition flex items-center gap-1.5"
                >
        ...
        <div className="space-y-12">
          {sections.map((section, i) => (
            ...
            >
              ...
              {section.footer && (
                <p className="mt-4 text-sm text-gray-600 italic">{section.footer}</p>
              )}
