            ...
            <AnimatePresence mode="wait">
              ...
              {step === 3 && (
                <motion.div key="step3" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}
                  ...
                  <div className="flex items-center gap-3 p-3 sm:p-4 bg-linear-to-r from-[#edf2f7] to-[#f0f4f8] rounded-xl">
                  ...
                  <div className="flex gap-3 pt-1">
                    ...
                    <button type="submit" disabled={loading}
                      className="flex-1 py-2.5 bg-linear-to-r from-[#0f2544] to-[#1a365d] text-white rounded-xl text-sm font-semibold hover:from-[#0a1628] hover:to-[#0f2544] transition disabled:opacity-50 shadow-md">
