          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-10">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                {script.premium ? (
                  <span className="text-[10px] font-black text-white bg-amber-500/90 px-2.5 py-1 rounded-lg">${script.price}</span>
                ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="p-4">
                          {/* Title */}
                          <h3 className={`text-[14px] font-bold leading-snug line-clamp-1 mb-2 transition-colors ${
